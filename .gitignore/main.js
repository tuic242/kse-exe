...
bot.on('message', function (message) {
	...
	.addField('**Reglement**', true)
        .addField('Pour le reglement generale : <#614153976526536818>', true) 
        .addField('Pour la hiérarchie et les article relatant au serveur Roblox Roleplay France : <#627906211592929330>', true)   
	.addField('**Lien**', true)
        .setTitle('Roblox Jeux')
        .setURL('https://www.roblox.com/games/2434529364/RP-FR-Ispagnac-V1-2-8', true)
        .setTitle('Roblox Groupe')
