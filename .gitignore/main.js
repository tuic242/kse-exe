...
bot.on('message', function (message) {
	...
	.addField('**Reglement**')
        .addField('Pour le reglement generale : <#614153976526536818>') 
        .addField('Pour la hiérarchie et les article relatant au serveur Roblox Roleplay France : <#627906211592929330>')   
	.addField('**Lien**')
        .addField('Roblox Jeux', true)
